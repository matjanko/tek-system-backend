...
@AllArgsConstructor
public class EmployeeTaskWithAdditionalCost implements Specification<EmployeeTask> {

    private final boolean isAdditionalCost;
    ...
    public Predicate toPredicate(Root<EmployeeTask> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        return cb.equal(root.get("isAdditionalCost"), 1);
    }
}
